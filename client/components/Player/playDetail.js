        ...
        <div className="player-wrapper">
          ...
          <div className="play-content">
            <div className="play-effect">
              <div className="cd-holder" style={{'opacity': showLyric ? 0 : 1}}
                   onClick={()=>this.toggleShow()}>
                <div className="stick"/>
                <div className="cd-wrapper">
                  <div className="cd-mask"/>
                  <img src="/imgs/play_song_cover.jpg" className="cd-img" />
                </div>
              </div>
              <div className="lyric-holder" onClick={()=>this.toggleShow()}
...
export default connect(select)(PlayDetail);